...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1652276601 or msg.sender_user_id_ == 1809976202 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/aboodes7ab/s7ab-/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/aboodes7ab/s7ab-/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/aboodes7ab/s7ab-/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/aboodes7ab/s7ab-/main/inc/functions.lua','./inc/functions.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or " FZRD"
...
usernn = data.username_ or "fzrdd"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "fzrdd"
end
Name = Name:gsub('[[][]]','')
...
result = false
if msg.sender_user_id_ == 1652276601 or msg.sender_user_id_ == 1809976202 then 
SudoBase = true
...
message = message ..i.. '-l ['..info.username..'](t.me/fzrdd) \n'
end
...
message = message ..k.. '-l ['..info.username..'](t.me/fzrdd) l » (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-l ['..info.username..'](t.me/fzrdd) l » (`' ..v.. '`) \n'
end
end
end
...
if UserID == 1652276601 or UserID == 1809976202 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ❕") end
