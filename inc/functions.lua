...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1652276601 or msg.sender_user_id_ == 879123322 then 
Adminn = true
...
if UserID == 1652276601 or UserID == 879123322 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ❕") end
