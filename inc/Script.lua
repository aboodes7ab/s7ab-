...
elseif UserID == 1652276601 or UserID == 1809976202  then  
...
if UserID == 1652276601 or UserID == 1809976202 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1652276601 or UserID == 1809976202 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/aboodes7ab/alyaf3e.github.io/main/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 1652276601 or UserID == 1809976202 then 
...
if FwdUser == 1652276601 or FwdUser == 1809976202 then 
