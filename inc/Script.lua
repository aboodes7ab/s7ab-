...
return sendMsg(msg.chat_id_,msg.id_,"- المالك :\n["..v.user.first_name.."](t.me/"..(v.user.username or "FZRDD"))
end
end
...
elseif UserID == 1652276601 or UserID == 879123322  then  
...
↫꙰🇸🇦 ممنوع اعاده التوجيه 🔃 
↫꙰🇸🇦 ممنوع التكلم بالطائفية 👌🏻
↫꙰🇸🇦 ممنوع الالفاظ الرديئة 🔞 
↫꙰🇸🇦 ممنوع نشر صور اباحية 📛
↫꙰🇸🇦 الرجاء احترام المشرفين 🧑🏻‍✈️ 
↫꙰🇸🇦 الرجاء احترام ضوابط القروب 👍
...
if UserID == 1652276601 or UserID == 879123322 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1652276601 or UserID == 879123322 then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
return '- اصدار سورس FZRD : *v'..version..'* '
end

if MsgText[1] == 'تحديث السورس' then
if not msg.SudoBase then return "- هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://alyaf3e.github.io/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'- عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس FZRD يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : FZRD ",url="t.me/FZRDD"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: FZRD](t.me/FZRDD)',nil,inline,msg.id_)
return false
end
...
return [[
Welcome To Source s7ab  
- s7ab TEAM   
𖣘ـ▬ـ▬s7ab▬ـ▬ـ𖣘  
  
📡❘ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐇𝐀](t.me/fcrathsel) 
  
📡❘ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐆𝐑𝐎𝐔𝐏](t.me/fkraha)  
  
👨🏻‍✈️❘ [𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑](t.me/DR_QRMOA) 

👨🏻‍✈️❘ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑](T.ME/VV4KV) 
  
𖣘ـ▬ـ▬𖣘s7ab𖣘▬ـ▬ـ𖣘𝐁𝐎𝐓 𝐂𝐇𝐀

لتنصيب بوت مثل هذا تواصل معي @vv4kv
...
if not msg.SudoBase then return "✧|  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://alyaf3e.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/fzrd/alyaf3e.github.io/main/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 1652276601 or UserID == 879123322 then 
...
if FwdUser == 1652276601 or FwdUser == 879123322 then 
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حماية FZRD ") end
...
"ماحـبـك 🙂🖤.",
"حبيبي يا الغالي 💗.",
"اذا اقولك احـبـك وشـ بتــستــفيد 🙂💙.",
"وخـر مـاحـبـك 😔😂.",
}
local song = {
"روح افرا قران بس 😔😂.",
...
return sendMsg(msg.chat_id_,msg.id_,"- ما اقدر اقول اكثر من 50 حرف 🙌🏾")
end
...
return sendMsg(msg.chat_id_,msg.id_,"امـوت فــيـك مـطـوري 💕.")
elseif msg.SudoUser and Text== "تحبني" or Text=="حبك" then 
return sendMsg(msg.chat_id_,msg.id_,"اكيـد احب مــطوري 💕.")
...
elseif Text== "شرح" then return sendMsg(msg.chat_id_,msg.id_,"انتظر وراح يشرحون لك ✅🥰.")
elseif Text== "شلونكم" or Text== "شلونك" or Text== "اخبارك" or Text== "اخباركم" then 
return sendMsg(msg.chat_id_,msg.id_,"تـمـام قـلـبي 💙+ انـت شـلـونـك شـخـبـارك؟")
elseif Text== "منورين"  then return sendMsg(msg.chat_id_,msg.id_,"بنـورك حـبــيـي 💙.")
elseif Text== "هاي"  then return sendMsg(msg.chat_id_,msg.id_,"تعال خاص بعلمك كيف تسلم 🌚.")
elseif Text== "منور"  then return sendMsg(msg.chat_id_,msg.id_,"بنــورك ♥️.")
elseif Text== "شكرا" or Text== "ثكرا" then return  sendMsg(msg.chat_id_,msg.id_,"عـ🌹ـفــ❤️ـوآ..")
elseif Text== "انت وين"  then return sendMsg(msg.chat_id_,msg.id_,"بالــبــ🏠ــيــت")
elseif Text== "اكرهك"  then return sendMsg(msg.chat_id_,msg.id_,"ما اهتم 🌚.")
elseif Text== "كلخرا" then return sendMsg(msg.chat_id_,msg.id_,"الرجاء الاحترام 🙂")
elseif Text== "كل خرا" then return sendMsg(msg.chat_id_,msg.id_,"الرجاء الاحترام 🙂")
elseif Text== "كلخرى" then return sendMsg(msg.chat_id_,msg.id_,"الرجاء الاحترام 🙂")
elseif Text== "كل خرى" then return sendMsg(msg.chat_id_,msg.id_,"الرجاء الاحترام 🙂")
elseif Text:match(Bot_Name.." شلونك$") then 
return sendMsg(msg.chat_id_,msg.id_,"تـمـام قـلـبي 💙+ انـت شـلـونـك شـخـبـارك؟")
elseif Text== "مرحبا"  then return sendMsg(msg.chat_id_,msg.id_,"وعليــكم الســـلام امــر ♥️.")
elseif Text== "سلام" or Text== "السلام عليكم" or Text== "سلام عليكم" or Text=="سلامن عليكم" or Text=="السلامن عليكم" then 
return sendMsg(msg.chat_id_,msg.id_,"وع̀́ليكم̀ آ̀لس̀́لآ̀م̀ وٍرٍحَمُةٌ اللَّــْـْہ وبر̀كآ̀ته⛤" )
elseif Text== "متعطل"  then return sendMsg(msg.chat_id_,msg.id_,"لا شـغـال 🙃🖤." )
elseif Text== "البوت متوقف" then return sendMsg(msg.chat_id_,msg.id_,"لا شـغـال 🙃🖤.")
elseif Text== "شغال"  then return sendMsg(msg.chat_id_,msg.id_,"شغال 💯 🚀.")
elseif Text== "بوت"  then return sendMsg(msg.chat_id_,msg.id_,"اسـمـي ["..Bot_Name.."] 💙.")
elseif Text== "وش اسمك"  then return sendMsg(msg.chat_id_,msg.id_,"مـكـتـوب فـوق🙂😂.")
...
- لا تندم فڪر قبل ڪل شي  
- بالتـوفيـق عزيزي ...
-ـ  https://telegram.org/deactivate
]] )
elseif Text== "سسم" or Text== "سم" or Text=="سمم" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"سم الله عدوك 🙂.")
end 
end 
